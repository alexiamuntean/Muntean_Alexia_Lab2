...
namespace Muntean_Alexia_Lab2.Migrations
{
    ...
    [Migration("20231109114348_Borrowings")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Muntean_Alexia_Lab2.Models.Borrowing", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Muntean_Alexia_Lab2.Models.Member", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Muntean_Alexia_Lab2.Models.Book", b =>
                {
                    ...
                    b.HasOne("Muntean_Alexia_Lab2.Models.Borrowing", "Borrowing")
                        .WithMany()
            ...
            modelBuilder.Entity("Muntean_Alexia_Lab2.Models.Borrowing", b =>
                {
                    b.HasOne("Muntean_Alexia_Lab2.Models.Member", "Member")
                        .WithMany("Borrowings")
